var idx = lunr(function () {
  ...
  this.ref('id')
    ...
    idx.add({
      ...
      excerpt: "On disabling the mapping of the parent node, it disables all the child node such that when the XML is...",
      categories: ["Transformation"],
      tags: ["developers"],
      id: 157
    });
...
var store = [
      ...
      {
        "title": "Hierarchial Rendering on Mapping State",
        "url": "/transformation/hierarchical-rendering-on-mapping-state/",
        "excerpt": "On disabling the mapping of the parent node, it disables all the child node such that when the XML is...",
        "teaser":
