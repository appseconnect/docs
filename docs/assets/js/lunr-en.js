var idx = lunr(function () {
  ...
  this.ref('id')
    ...
    idx.add({
      ...
      excerpt: "Why do you need element in Workflow? Workflow Elements is a easy to use solution for APPSeCONNECT that provides you...",
      categories: ["Workflow"],
