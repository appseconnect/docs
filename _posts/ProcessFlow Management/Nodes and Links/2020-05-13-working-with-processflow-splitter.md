...
4) [Deploy]() the Process flow. After successful deployment, to your environment, [Execute]() the Processflow.  
5) Go to [Environment]()section of the portal, select the process flow from the listing section and click [View Snapshot]()    
...
![Splitter2](../../../staticfiles/processflow/media/mapper/splitter2.PNG)   
...
![Splitter2](../../../staticfiles/processflow/media/mapper/splitter3.PNG)     
