...
4. After providing the necessary details, Click on Validate and Save.
...
and if touchpoints don't sync, this basic issue resolves after removing the Temp and Cache files from the portal and 
from your system. 
