...
|orders|orders|GET|order|[This will get orders from Magento2 for posting in any destination application](https://docs.magento.com/m2/ce/user_guide/customers/customer-account-create-order.html)|
|product|POST.json|POST|product|This will Create order in Magento 2 from Source Application|
|stockItem|PUT.json|PUT|stockItem|This will update inventory in Magento2 from any source Application|
