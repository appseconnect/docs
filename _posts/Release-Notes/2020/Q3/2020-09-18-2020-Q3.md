...
This release also presents the revamped [menu of the portal](/accessing%20portal/accessing-portal/) for better user experience. 
The new set of functional menus are easy to navigate and ease the method of integration via our Portal. 
