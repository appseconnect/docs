var idx = lunr(function () {
  ...
  this.ref('id')
    ...
    idx.add({
      ...
      excerpt: "The Environment is a section in the AEC Portal where the two types of agents that is the On-Premise Agent...",
    ...
    idx.add({
      ...
      excerpt: "An action filter is an attribute that you can apply to a controller action – or an entire controller –...",
      categories: ["API-Management"],
      tags: ["developers"],
      id: 110
    });
