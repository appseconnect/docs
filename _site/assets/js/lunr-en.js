var idx = lunr(function () {
  ...
  this.ref('id')
    ...
    idx.add({
      ...
      excerpt: "Here are the list of tokens required for rule creation in APPSeCONNECT RuleTokenName Syntax Description Type Applied On ReSyncBucketCountOlderThanHours ~{ReSyncBucketCountOlderThanHours(20)}~...",
      categories: ["Rule"],
      tags: ["developers"],
      id: 179
    });
