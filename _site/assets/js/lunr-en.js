var idx = lunr(function () {
  ...
  this.ref('id')
    ...
    idx.add({
      ...
      excerpt: "Getting started with deployment This section lets you get started with the deploying processes and components to an environment for...",
      categories: ["Deployment"],
      tags: ["developers"],
      id: 75
    });
...
var store = [
      ...
      {
        "title": " Creating proxy endpoint",
        "url": "/api-management/steps-to-create-proxy-endpoint-Copy/",
        "excerpt": "Proxies are the full REST (Representational State Transfer) services which allows to create proxy over a set of existing data...",
        "teaser":
